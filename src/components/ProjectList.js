    ...
    return(
        <ul>
            <li>
                ...
                <a href="https://github.com/Matt-Matthaiou/Target_Practice_Trading"><button >View Code</button></a>
            </li>
            <li>
                ...
                <a href="https://github.com/Matt-Matthaiou/Vet_management_project"><button>View Code</button></a>
            ...
            <li>
                ...
                <a href="https://github.com/Matt-Matthaiou/week7_hw_mtgDeckBuilder"><button>View Code</button></a>
                <a href="https://matt-matthaiou.github.io/Mtg_Deck_Builder/"><button>View Demo</button></a>
            </li>
        </ul>
    )
}
